...
# PyroClient Setup 
API_ID = int(environ['29817626'])
API_HASH = environ['c530823a3feb1ebfea88b609708384a6']
BOT_TOKEN = environ['6669980593:AAGFUULM1tnLo6jGTZghee9p2OAHm-2sjCg']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('https://t.me/f7moviesofficial', '1').split()]
...
FILE_DB_URL = environ.get("FILE DB URL", DATABASE_URL)
FILE_DB_NAME = environ.get("FILE DB NAME", DATABASE_NAME)
...
WELCOM_TEXT = environ.get("WELCOM_TEXT", script.Heybuddy)
...
LOG_CHANNEL = int(environ.get('https://t.me/+39zjsdNl3xgwZGQ1', 0))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'https://t.me/+ae80oMyBsZExNDM1')).split()]
